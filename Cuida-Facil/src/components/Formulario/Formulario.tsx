        ...
        <div>
          ...
          >
            ...
            {especialidades.map(esp => (
              <option key={esp.idEspecialidade} value={String(esp.idEspecialidade)}>
                {esp.nome}
              </option>
            ))}
          </select>
        ...
        {especialidadeId !== '' && unidadeId !== '' && (
          <div>
            ...
            >
              ...
              {medicos.map(m => (
                <option key={m.idMedico} value={String(m.idMedico)}>
                  {m.nome} - {m.crm}
                </option>
              ))}
            </select>
          ...
          <div className="radio-container">
            <label className={`radio-label ${tipoAtendimento === 'PRESENCIAL' ? 'selected' : ''}`}>
              <input 
                ...
                onChange={e => setTipoAtendimento(e.target.value as 'PRESENCIAL')} 
            ...
            <label className={`radio-label ${tipoAtendimento === 'TELECONSULTA' ? 'selected' : ''}`}>
              <input 
                type="radio" 
                value="TELECONSULTA" 
                checked={tipoAtendimento === 'TELECONSULTA'} 
                onChange={e => setTipoAtendimento(e.target.value as 'TELECONSULTA')} 
                className="radio-input"
              />
